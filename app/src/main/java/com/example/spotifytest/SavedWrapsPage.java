...
public class SavedWrapsPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saved_wraps);

        RecyclerView wrapsRecycler = (RecyclerView) findViewById(R.id.savedWrapsRecycler);
        ...
        ArrayList<String> wrapsList = new ArrayList<>();
